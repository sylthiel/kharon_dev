...
class SalesforceRequestHandler(RequestHandlerBase):
    ...
    def populate_yti_details(self):
        ...
        try:
            existing_case = self.sf.YoutrackIssue__c.get_by_custom_id('YTReadableId__c', yti_details['YTReadableId'])
            return self.sf.YoutrackIssue__c.update(existing_case['Id'], prepared_yti_details)
        except SalesforceResourceNotFound:
            return self.sf.YoutrackIssue__c.create(prepared_yti_details)
